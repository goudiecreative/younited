...
export interface ApiLandingPageLandingPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoriesHighlighted: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faq: Schema.Attribute.Component<'shared.faq', true>;
    feature1Description: Schema.Attribute.Text;
    feature2Description: Schema.Attribute.Text;
    feature3Description: Schema.Attribute.Text;
    featureHeading1: Schema.Attribute.String;
    featureHeading2: Schema.Attribute.String;
    featureHeading3: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    numberChapters: Schema.Attribute.String;
    numberLessons: Schema.Attribute.String;
    program_id: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Lessons: Schema.Attribute.Relation<'manyToMany', 'api::program.program'>;
    lessonSummary: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::lesson.lesson'
    ...
    ProgramInfo: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
    thumbnail: Schema.Attribute.Media<'images'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['video', 'PDF', 'text', 'assessment']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    numberChapters: Schema.Attribute.String;
    numberLessons: Schema.Attribute.String;
    programFeatures: Schema.Attribute.Component<
    ...
    > &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    programLessons: Schema.Attribute.Relation<
      'manyToMany',
      'api::lesson.lesson'
    >;
    programSubhead: Schema.Attribute.String;
    programthumbnail: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiUserUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    events: Schema.Attribute.Relation<'oneToMany', 'api::userevent.userevent'>;
    firstName: Schema.Attribute.String;
    lastName: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['Student', 'Instructor', 'Admin']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiUsereventUserevent extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Userevent';
    pluralName: 'userevents';
    singularName: 'userevent';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    relatedBadge: Schema.Attribute.Relation<'oneToOne', 'api::badge.badge'>;
    relatedLesson: Schema.Attribute.Relation<'oneToOne', 'api::lesson.lesson'>;
...
export interface ApiUserprogressUserprogress
  extends Struct.CollectionTypeSchema {
  collectionName: 'userprogresses';
  info: {
    displayName: 'Userprogress';
    pluralName: 'userprogresses';
    singularName: 'userprogress';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lastActivityTimestamp: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::userprogress.userprogress'
    > &
      Schema.Attribute.Private;
    points: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::userevent.userevent': ApiUsereventUserevent;
      'api::userprogress.userprogress': ApiUserprogressUserprogress;
